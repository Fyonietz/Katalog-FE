...
// Helper untuk menyambung VITE_API_BASE_URL dengan imagePath relatif API
...
export default function ProductModal({
  ...
  const namaStatus = produk.statusProduct?.nama ?? "Tersedia";
            ...
            >
              ...
              <div className="w-full md:w-[45%] p-6 md:p-10 flex flex-col bg-[#1B2A6B] text-white overflow-y-auto no-scrollbar">
                ...
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <span className="bg-green-500/20 text-green-300 border border-green-500/30 px-3 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase">
                    {namaStatus}
                  </span>
                </div>
